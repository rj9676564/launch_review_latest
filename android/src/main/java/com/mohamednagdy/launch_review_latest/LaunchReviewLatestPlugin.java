package com.mohamednagdy.launch_review_latest;
...
/**
 * LaunchReviewLatestPlugin
 */
public class LaunchReviewLatestPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
    Activity activity;

    private static LaunchReviewLatestPlugin register(LaunchReviewLatestPlugin plugin, BinaryMessenger messenger, Activity activity) {
